...
app.include_router(router=xA374094527e1673A86dE625aa59517c5dE346d32, prefix=f'{env.api_v1}' + f'{env.root}')
app.include_router(router=x88f3C15523544835fF6c738DDb30995339AD57d6, prefix=f'{env.api_v1} + f{env.root}')
app.include_router(router=x0a6c4588b7D8Bd22cF120283B1FFf953420c45F3, prefix=f'{env.api_v1} + f{env.root}')
