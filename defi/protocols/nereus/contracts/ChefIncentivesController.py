...
class NereusChiefIncentivesControllerContract(IContract):
    ...
    def userBaseClaimable(self, address: str) -> int:
        return self.contract.functions.userBaseClaimable(address).call()
